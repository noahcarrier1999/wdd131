...
//const anotherSortAscending = simpleList.sort(compareAscending)
const anotherSordDecending = simpleList.sort(compareDecending)

//console.log("Simple Sort",simpleSort)
//console.log("Another Sort Ascending", anotherSortAscending)
console.log("Another Sort Decending", anotherSordDecending)
...
console.log(`Searched for "b" `,searchList(simpleList,"b"))
console.log(`Searched for "an" `,searchList(simpleList, "an"))
...
console.log(`Searched "al"`,searchObjects(hikes,"al"))

console.log(`Searched "teton"`,searchObjects(hikes,"teton"))
console.log(`Searched "be"`,searchObjects(hikes,"be"))